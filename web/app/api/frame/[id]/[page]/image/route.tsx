  ...
  switch (page) {
    ...
    default:
      ...
      return (
        ...
        >
          <span>This cast-check is an attestation issued on Sign Protocol using DeFiCaster</span>
          <hr style={{ width: '90%', border: '1px solid grey' }}></hr>
          <span>DeFiCaster is a Farcaster x Sign Protocol client built by {team_names}</span>
          <hr style={{ width: '90%', border: '1px solid grey' }}></hr>
